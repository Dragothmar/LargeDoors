package dragothmar.largedoors.common.blocks;

import dragothmar.largedoors.LargeDoors;
 ...
 *
 *
 * TODO: Look up some mods on how they register blocks/itemblocks
 */
public class BlockTestDoor extends Block
{
    ...
    public BlockTestDoor(String name, Material materialIn)
    {
        super(materialIn);
        ...
        this.name = name;
        this.setUnlocalizedName(LargeDoors.MODID + "." + name);

        this.setCreativeTab(LargeDoors.creativeTab);


        Content.registeredLDBlocks.add(this);

        //Content.registeredLDItems.add(ItemBlock.getItemFromBlock(this));
    }

    private String name;
    public ResourceLocation getResourceLocation()
    {
        return new ResourceLocation(LargeDoors.MODID + ":" + name);
    }
